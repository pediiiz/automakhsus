...
export const metadata: Metadata = pageMetadata({
  ...
  description: "اکوسیستم Auto Makhsus شامل هاب فنی خودروهای خارجی، فروشگاه قطعات، تهران صندلی، Tuduzi، ANI2203 و پلتفرم دیجیتال خودرو است.",
  path: "/fa/ecosystem",
});
...
export default function EcosystemPage() {
  return (
    <main>
      ...
      <PageHero eyebrow="Projects / Ecosystem" title="اکوسیستم فنی، تجاری و دیجیتال Auto Makhsus" description="Auto Makhsus برندها، خدمات فنی، فروشگاه قطعات، نصب، گارانتی و سوابق دیجیتال خودرو را به یک سیستم قابل توسعه برای بازار خودروهای خارجی تبدیل می‌کند." image={visual.network} />
      <BrandEcosystem />
      <TechnicalServices />
      <ForeignCarBrands />
      <MarketplaceSection />
