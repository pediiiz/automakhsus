...
export const storeCategories: StoreCategory[] = marketplaceCategories.map((category) => ({
  ...
  seoTitle: `${category.title} خودرو | فروشگاه Auto Makhsus`,
  metaDescription: `${category.description} استعلام قیمت، خرید قطعه و خرید + نصب در Auto Makhsus برای خودرو.`,
}));
...
export const storeProducts: StoreProduct[] = [
  ...
  },
  {
    ...
    priceLabel: "استعلام قیمت",
    stockStatus: "نیازمند بررسی",
    shortDescription: "مواد محافظت بدنه برای پروژه‌های دیتیلینگ خودرو.",
  ...
  },
  {
    ...
    vehicleCompatibility: ["بدنه خودرو"],
    priceLabel: "استعلام قیمت",
    stockStatus: "سفارشی",
  ...
  },
  {
    ...
    priceLabel: "استعلام قیمت",
    stockStatus: "سفارشی",
    shortDescription: "ابزارهای فنی و تجهیزات کارگاهی برای سرویس خودرو.",
