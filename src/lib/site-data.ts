...
export const servicePillars = [
  ["technical-service", "خدمات فنی خودرو", "مکانیک، سرویس دوره‌ای، دیاگ، برق، گیربکس، جلوبندی، ترمز و کارشناسی قبل خرید.", "01"],
...
export const technicalServices = [
  ["mechanics", "مکانیک و سرویس دوره‌ای", "سرویس و عیب‌یابی مکانیکی خودرو با ثبت سابقه در CRM."],
  ...
  ["bodywork", "صافکاری", "بازدید، برنامه‌ریزی و اجرای پروژه‌های بدنه برای خودرو."],
...
export const marketplaceCategories = [
  ["consumables", "قطعات مصرفی", "فیلتر، روغن، لنت، شمع، تسمه و اقلام مصرفی خودرو."],
  ...
  ["used", "Used", "قطعات استوک و سالم برای خودرو، با بررسی و ثبت وضعیت."],
...
export const trustSignals = [
  "مرکز تخصصی خودرو",
  "فروشگاه قطعات، مواد مصرفی و تجهیزات خودرو",
