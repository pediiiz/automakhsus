...
export const academyArticles: ContentCard[] = [
  {
    ...
    title: "راهنمای دیاگ تخصصی خودرو",
    ...
    sections: [
      { title: "دیاگ یعنی تحلیل، نه فقط پاک کردن خطا", body: "در خودرو، یک خطای ساده می‌تواند نتیجه افت ولتاژ، خرابی سنسور، مشکل سیم‌کشی، آپدیت نرم‌افزاری یا خرابی مکانیکی باشد. Auto Makhsus دیاگ را به عنوان یک فرآیند تشخیص مرحله‌ای می‌بیند، نه یک عملیات سریع و سطحی." },
  ...
  },
  {
    ...
    title: "برنامه نگهداری خودرو در ایران",
    eyebrow: "Maintenance Guide",
    summary: "چطور سرویس دوره‌ای، قطعات مصرفی و یادآوری‌ها را برای خودروهای وارداتی مدیریت کنیم.",
    description: "شرایط رانندگی، کیفیت سوخت، ترافیک و دسترسی به قطعه باعث می‌شود برنامه نگهداری خودرو در ایران نیازمند دقت بیشتر باشد.",
    ...
    sections: [
      ...
      { title: "قطعات مصرفی مهم", body: "روغن، فیلتر، لنت، شمع، تسمه، روغن گیربکس، باتری و اقلام تعلیق برای خودرو باید با کیفیت و سازگاری درست انتخاب شوند." },
    ...
    faqs: [
      { question: "سرویس دوره‌ای خودرو وارداتی چند وقت یکبار لازم است؟", answer: "بسته به برند، مدل، کیلومتر و شرایط مصرف متفاوت است؛ اما ثبت سابقه و بازدید منظم مهم‌تر از حدس‌زدن است." },
  ...
  },
  {
    ...
    title: "کارشناسی قبل خرید خودرو",
    eyebrow: "Inspection Guide",
    summary: "چک‌لیست فنی، بدنه، رنگ، دیاگ و کابین برای خرید امن خودرو وارداتی.",
    description: "خرید خودرو وارداتی بدون کارشناسی دقیق می‌تواند هزینه‌های پنهان مکانیکی، برقی، بدنه، رنگ و قطعات کمیاب ایجاد کند.",
    ...
    sections: [
      { title: "کارشناسی فقط رنگ‌سنجی نیست", body: "برای خودرو وارداتی باید دیاگ، موتور، گیربکس، تعلیق، برق، کابین، آپشن‌ها، سوابق سرویس، بدنه و دسترسی قطعات با هم بررسی شود." },
    ...
    faqs: [
      { question: "آیا کارشناسی قبل خرید شامل دیاگ است؟", answer: "در مدل Auto Makhsus، دیاگ یکی از بخش‌های اصلی کارشناسی خودرو وارداتی است." },
...
export const videos: VideoContent[] = [
  {
    ...
    chapters: [
      ...
      { time: "00:48", title: "خواندن کد و داده زنده", summary: "تفاوت کد خطا، داده زنده و تست عملی در خودرو." },
  ...
  },
  {
    ...
    description: "نصب آپشن در خودرو باید با ظاهر کارخانه‌ای، سیم‌کشی ایمن و QC انجام شود.",
...
export const projects: ProjectContent[] = [
  ...
  },
  {
    ...
    summary: "مسیر آماده‌سازی، اصلاح سطح و محافظت نهایی برای خودرو.",
...
export const feedItems: FeedContent[] = [
  {
    ...
    eyebrow: "Daily Feed",
    summary: "چند خودروی وارداتی برای بررسی خطا، برق و سرویس وارد صف عملیاتی شدند.",
...
export const questions: QuestionContent[] = [
  {
    ...
    eyebrow: "Q&A",
    summary: "دلایل فنی برگشت چراغ چک و مسیر تشخیص درست در خودرو.",
    description: "پاک کردن خطا مشکل اصلی را حل نمی‌کند و در خودرو باید علت ریشه‌ای خطا بررسی شود.",
    category: "عیب‌یابی",
  ...
  },
  {
    ...
    title: "بعد از خرید خودرو وارداتی کارکرده چه سرویس‌هایی مهم‌تر است؟",
    eyebrow: "Owner Question",
    summary: "اولویت‌های اولیه بعد از خرید خودرو وارداتی دست دوم.",
    description: "برای خودرو وارداتی کارکرده، اولویت با دیاگ، سرویس مصرفی، بررسی گیربکس، ترمز، تعلیق و سوابق است.",
    category: "نگهداری",
    ...
    acceptedAnswer: "بعد از خرید خودرو وارداتی کارکرده، ابتدا دیاگ کامل، بررسی روغن‌ها، فیلترها، ترمز، تعلیق، باتری، گیربکس، نشتی‌ها و سوابق سرویس را انجام دهید. سپس برای قطعات مصرفی و سرویس‌های بعدی برنامه بسازید.",
    relatedServices: ["inspection", "mechanics", "brake"],
    sections: [
      { title: "صورت سوال", body: "یک خودرو وارداتی کارکرده خریده‌ام. برای جلوگیری از هزینه‌های سنگین، اول چه چیزهایی را بررسی کنم؟" },
...
const seedArticles: Omit<ContentCard, "image" | "date" | "path" | "relatedServices" | "sections" | "faqs">[] = [
  ...
  { slug: "imported-car-parts-buy-install", title: "خرید قطعه خودرو وارداتی همراه نصب", eyebrow: "Marketplace Guide", summary: "چرا خرید + نصب در Auto Makhsus برای قطعات حساس منطقی‌تر است.", description: "خرید قطعه بدون بررسی سازگاری و نصب می‌تواند دوباره‌کاری ایجاد کند؛ مسیر خرید + نصب به CRM، فاکتور و پروژه متصل می‌شود.", category: "فروشگاه قطعات", tags: ["قطعات خودرو", "خرید + نصب", "OEM"], service: "فروشگاه قطعات", readTime: "۷ دقیقه" },
  { slug: "detailing-foreign-cars", title: "دیتیلینگ خودرو؛ محافظت از ارزش خودرو", eyebrow: "Detailing", summary: "دیتیلینگ، PPF، سرامیک و مراقبت بدنه برای خودرو.", description: "دیتیلینگ حرفه‌ای فقط زیبایی نیست؛ بخشی از نگهداری ارزش خودرو، کابین و رنگ محسوب می‌شود.", category: "دیتیلینگ", tags: ["دیتیلینگ", "PPF", "سرامیک"], service: "دیتیلینگ خودرو", readTime: "۶ دقیقه" },
  { slug: "foreign-car-options-safe-install", title: "نصب آپشن خودرو بدون آسیب", eyebrow: "Options", summary: "اصول نصب آپشن، سیم‌کشی و کنترل کیفیت برای خودروهای وارداتی.", description: "هر آپشن باید از نظر برق، ماژول و سازگاری بررسی شود و بعد از نصب تست و ثبت گارانتی شود.", category: "آپشن خودرو", tags: ["آپشن خودرو", "نصب", "برق"], service: "آپشن و ارتقا", readTime: "۷ دقیقه" },
  { slug: "imported-car-gearbox-warning-signs", title: "علائم هشدار گیربکس خودرو", eyebrow: "Gearbox", summary: "تقه، تاخیر، داغی و حالت اضطراری گیربکس را جدی بگیرید.", description: "خرابی گیربکس خودرو معمولاً قبل از هزینه سنگین با نشانه‌هایی قابل تشخیص است.", category: "گیربکس", tags: ["گیربکس", "دیاگ", "تعمیرگاه خودرو"], service: "گیربکس", readTime: "۸ دقیقه" },
];
...
academyArticles.push(...seedArticles.map((item) => ({
  ...
  sections: [
    { title: "مسئله اصلی", body: `${item.title} برای مالک خودرو مهم است چون تصمیم اشتباه در تشخیص، قطعه یا نصب می‌تواند هزینه و زمان پروژه را بالا ببرد.` },
...
const seedVideos: Omit<VideoContent, "image" | "poster" | "date" | "path" | "relatedServices" | "sections" | "faqs" | "chapters" | "relatedCars" | "transcript">[] = [
  ...
  { slug: "detailing-ppf-ceramic-video", title: "PPF، سرامیک و دیتیلینگ خودرو", eyebrow: "Detailing Video", summary: "تفاوت پوشش‌ها و انتخاب مناسب برای خودروهای وارداتی.", description: "این ویدئو به مالک کمک می‌کند بین دیتیلینگ، سرامیک، PPF و کاور تصمیم بگیرد.", category: "ویدئو دیتیلینگ", tags: ["دیتیلینگ", "PPF"], service: "دیتیلینگ خودرو", duration: "05:35" },
  { slug: "options-safe-install-video", title: "نصب ایمن آپشن خودرو", eyebrow: "Options Video", summary: "سازگاری، سیم‌کشی، تست و QC نصب آپشن.", description: "ویدئو نشان می‌دهد چرا نصب آپشن باید با کنترل برق و ظاهر کارخانه‌ای انجام شود.", category: "ویدئو آپشن", tags: ["آپشن", "نصب"], service: "آپشن و ارتقا", duration: "04:35" },
  { slug: "gearbox-warning-video", title: "نشانه‌های هشدار گیربکس اتومات", eyebrow: "Gearbox Video", summary: "تقه، تاخیر، داغی و چراغ گیربکس را بشناسید.", description: "ویدئو آموزشی برای تشخیص زودهنگام ریسک خرابی گیربکس خودرو.", category: "ویدئو فنی", tags: ["گیربکس", "دیاگ"], service: "گیربکس", duration: "05:20" },
];
...
videos.push(...seedVideos.map((item) => ({
  ...
  transcript: `${item.title}: در این ویدئو مسیر تشخیص، تصمیم فنی، انتخاب قطعه یا نصب و ثبت درخواست در CRM توضیح داده می‌شود تا مالک خودرو با دید روشن اقدام کند.`,
  chapters: [
...
const seedProjects: Omit<ProjectContent, "image" | "date" | "path" | "relatedServices" | "sections" | "faqs" | "stages">[] = [
  ...
  { slug: "kia-optima-buy-install-options", title: "خرید + نصب آپشن Kia Optima", eyebrow: "Options Project", summary: "سازگاری قطعه، نصب تمیز و QC.", description: "نمونه پروژه فروشگاه + نصب برای آپشن خودرو.", category: "آپشن", tags: ["Kia", "Optima"], brand: "Kia", model: "Optima", service: "آپشن و ارتقا", vehicle: "Kia Optima", executionTime: "یک روز کاری" },
...
const seedFeed: Omit<FeedContent, "image" | "date" | "path" | "relatedServices" | "sections" | "faqs">[] = [
  ...
  { slug: "today-benz-electrical", title: "یادداشت امروز: خطاهای برقی Benz", eyebrow: "Daily Feed", summary: "تمرکز امروز روی افت ولتاژ و ماژول‌های رفاهی بنز بود.", description: "پست روزانه آموزشی و عملیاتی برای خودرو.", category: "برق", tags: ["Benz", "ماژول"], service: "برق و الکترونیک", format: "photo" },
  ...
  { slug: "detailing-premium-queue", title: "یادداشت دیتیلینگ خودروهای لوکس", eyebrow: "Daily Feed", summary: "چند پروژه محافظت رنگ و کابین برای خودروهای وارداتی بررسی شد.", description: "فید روزانه می‌تواند به پروژه، ویدئو و رزرو سرویس وصل شود.", category: "دیتیلینگ", tags: ["دیتیلینگ", "سرامیک"], service: "دیتیلینگ خودرو", format: "project" },
  ...
  { slug: "special-order-parts-note", title: "یادداشت سفارش وارداتی قطعه", eyebrow: "Marketplace Feed", summary: "Special Order باید با خودرو، مشتری، فاکتور و نصب مرتبط شود.", description: "پست فروشگاهی درباره مسیر سفارش خاص قطعات خودرو وارداتی.", category: "فروشگاه", tags: ["Special Order"], service: "فروشگاه قطعات", format: "photo" },
];
...
const seedQuestions: Omit<QuestionContent, "image" | "date" | "path" | "relatedServices" | "sections" | "faqs" | "acceptedAnswer">[] = [
  ...
  { slug: "foreign-car-detailing-value", title: "دیتیلینگ چه تاثیری روی ارزش خودرو دارد؟", eyebrow: "Q&A", summary: "نقش دیتیلینگ، سرامیک و PPF در حفظ ارزش خودرو.", description: "پاسخ کوتاه درباره نگهداری ظاهر و کابین.", category: "دیتیلینگ", tags: ["دیتیلینگ"], service: "دیتیلینگ خودرو" },
  { slug: "safe-options-installation", title: "نصب آپشن روی خودرو خطر دارد؟", eyebrow: "Q&A", summary: "اگر سازگاری برق بررسی نشود، بله.", description: "نکات نصب ایمن آپشن و کنترل کیفیت.", category: "آپشن", tags: ["آپشن"], service: "آپشن و ارتقا" },
...
function brandMeta(slug: string) {
  return brandRegionMap[slug] || { originCountry: "جهانی", category: "خودرو", regions: ["Global"] };
}
...
function seedModel(slug: string, name: string, fa: string, generations: [string, string, string][]): VehicleModel {
  ...
  return {
    ...
    intro: `${fa} در دانشنامه Auto Makhsus به عنوان یک مدل مهم بازار خودرو پوشش داده می‌شود؛ تمرکز صفحه روی سرویس، دیاگ، قطعات، آپشن، دیتیلینگ و مسیر استعلام قطعه یا رزرو سرویس است.`,
...
const globalBrandCatalog: BrandSeed[] = [
  ...
  ["volkswagen", "Volkswagen", "فولکس‌واگن", "فولکس‌واگن در هاب خودرو Auto Makhsus برای سرویس، قطعه و عیب‌یابی پوشش داده می‌شود.", [
  ...
  ["jeep", "Jeep", "جیپ", "جیپ برای سرویس فنی، تعلیق، برق و قطعات کاربردی در هاب خودرو پوشش داده می‌شود.", [
  ...
  ["nissan", "Nissan", "نیسان", "نیسان در خدمات خودرو برای سرویس، قطعه، دیاگ و نگهداری پوشش دارد.", [
  ...
  ["ford", "Ford", "فورد", "فورد در دانشنامه خودرو برای SUV، پیکاپ و خودروهای وارداتی مهم پوشش دارد.", [
...
export const ecosystemLinks = [
  { title: "Academy", fa: "آکادمی", href: "/fa/academy", description: "مقالات فنی، راهنمای نگهداری، عیب‌یابی و آموزش خودرو.", accent: "#0b5cff" },
  ...
  { title: "Vehicle Knowledge Base", fa: "دانشنامه خودرو", href: "/fa/cars", description: "هاب برند و مدل برای BMW، Mercedes، Porsche، Toyota، Lexus و دیگر خودرو.", accent: "#06b6d4" },
